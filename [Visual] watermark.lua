...
local is_beta = pcall(ui_reference, "MISC", "Settings", "Anti-untrusted")
...
local watermark_items = {
	{
		...
		get_width = function(self, frame_data)
			...
			self.beta_width = (is_beta and (renderer_measure_text(nil, "")) or 0)
		...
		draw = function(self, x, y, w, h, r, g, b, a)
			...
			if is_beta then
				renderer_text(x+self.game_width+self.sense_width, y, 255, 255, 255, a*0.9, nil, 0, "")
			end
		end
	},
	{
